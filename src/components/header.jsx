                ...
                <ul className="flex p-0 items-center">
                    <li className="inline-block text-black text-[14px] py-[4px] px-[10px] mx-[5px]">
                        <Link href="/" className="flex flex-col items-center justify-center">
                            <h3 className="text-[18px]">Pony Party</h3>
                            <p className="text-[10px]">IV HYDRATION</p>
                        </Link>
                    </li>
                </ul>
                <ul className="flex p-0 items-center">
                    <li className="inline-block text-black text-[14px] py-[4px] mx-[6px] rounded-full">
                        <Link href="/">In-Home Services</Link>
                    </li>
                    <li className="inline-block text-black text-[14px] py-[4px] mx-[8px] rounded-full">
