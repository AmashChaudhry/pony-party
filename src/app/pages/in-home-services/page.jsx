...
export default function InHomeServices() {
    return (
        <div className="flex flex-col items-center">
            <div className="flex flex-col items-center px-[30px] py-[40px] sm:py-[60px] sm:pb-[60px] sm:w-[700px] lg:py-[80px] lg:pb-[90px] xl:py-[100px] xl:pb-[150px]">
                <h1 className="text-[22px] text-center font-medium py-[20px] sm:text-[34px]">Mobile Medical Service Menu</h1>
