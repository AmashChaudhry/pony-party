...
export default function ContactUs() {
      ...
      if (response.ok) {
        ...
        emailjs
          .send(
            ...
            {
              from_email: "sayyambutt317@gmail.com",
              to_email: "optimus.tts@gmail.com",
        ...
        console.error("Failed to save data in the database.");
      }
    } catch (error) {
  ...
  return (
    <div
      className="flex flex-col items-start w-full max-w-[1200px] mx-auto px-[20px] py-[40px]"
      style={{ minHeight: "calc(100vh - 80px)" }}
    >
      <h1 className="text-2xl font-semibold mb-[10px]">Contact Us</h1>
      <p>
        Please fill out the form below and a member of our team will get back
        with you shortly.
      </p>
      <div className="flex flex-col items-start w-full max-w-[500px] py-[40px]">
        <div className="mb-[15px] w-full">
        ...
        <div className="mb-[25px] w-full">
          <label className="text-black text-opacity-60">How can we help?</label>
          <br />
          <select
            className="w-full p-[15px] text-[14px] bg-[rgba(0,0,0,0.05)] border-l-4 border-l-[#ffa9f9] focus:outline-none"
            id="category"
          ...
          >
            <option value="General Inquiry">General Inquiry</option>
            <option value="Booking an Appointment">
              Booking an Appointment
            </option>
            <option value="Marketing Inquiries">Marketing Inquiries</option>
            <option value="Event or On-Site Services">
              Event or On-Site Services
            </option>
            <option value="Partnership/Consulting">
        ...
        {sent ? (
          <div className="mb-[15px] w-full bg-green-100 p-[10px] rounded">
            <p className="text-green-600 text-[14px]">
              Message successfully sent, our team will get back with you
              shortly.
            </p>
          </div>
        ) : null}
        <button
          className={`${
            buttonDisabled
              ...
              : "bg-[#ffa9f9] hover:bg-black text-white"
          } w-fit py-[15px] px-[20px]`}
          type="submit"
          disabled={buttonDisabled}
          onClick={sendMessage}
        >
