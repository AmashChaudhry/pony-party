...
export default function PrivacyPolicy() {
    return (
        <div className='flex flex-col items-start w-full max-w-[1000px] mx-auto p-5'>
            ...
            <h2 className="text-xl font-semibold mt-6">Interpretation and Definitions</h2><br />
            <h3 className="font-semibold">Interpretatioin</h3>
            <p className="mb-4">
                The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
            </p>
            <h3 className="font-semibold">Defination</h3>
            <p className="mb-4">
            ...
            <ul className="list-disc pl-8 mb-4">
                ...
                <li> <b>Company</b> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Pony Party LLC, 815 N 52nd St Phoenix, AZ 85008 United States.</li>
                ...
                <li> <b>Country</b>refers to: Arizona, United States</li>
                ...
                <li><b>Website</b> refers to Pony Party IV, accessible from  <a href="https://ponypartyiv.com" className="text-blue-500">https://ponypartyiv.com</a></li>
            ...
            <h2 className="text-xl font-semibold mt-6">Collecting and Using Your Personal Data</h2><br />
            <h3 className="font-semibold">Types of Data Collected</h3><br />
            <h4 className="font-semibold">Personal Data</h4><br />
            <p className="mb-4">
            ...
            <h2 className="text-xl font-semibold mt-6">Usage Data</h2>
            <p className="mb-4">
            ...
            <h2 className="text-xl font-semibold mt-6">Information from Third-Party Social Media Services</h2>
            <p className="mb-4">
            ...
            <h2 className="text-xl font-semibold mt-6">Tracking Technologies and Cookies</h2>
            <p className="mb-4">
            ...
            <h2 className="text-xl font-semibold mt-6">Retention of Your Personal Data</h2>
            <p className="mb-4">
            ...
            <h2 className="text-xl font-semibold mt-6">Transfer of Your Personal Data</h2>
            <p className="mb-4">
            ...
            <h2 className="text-xl font-semibold mt-6">Delete Your Personal Data</h2>
            <p className="mb-4">
            ...
            <h2 className="text-xl font-semibold mt-6">Disclosure of Your Personal Data</h2>
            ...
            <h2 className="text-xl font-semibold mt-6">Children&apos;s Privacy</h2><br />
            <p className="mb-4">
            ...
            <h2 className="text-xl font-semibold mt-6">Links to Other Websites</h2><br />
            <p className="mb-4">
            ...
            <h2 className="text-xl font-semibold mt-6">Changes to this Privacy Policy</h2><br />
            <p className="mb-4">
            ...
            <h2 className="text-xl font-semibold mt-6">Contact Us</h2><br />
            <p className="mb-4">
                If you have any questions about this Privacy Policy, You can contact us:
            </p>
            <ul className="list-disc mb-4 pl-8">
                <li>By email: info@ponypartyiv.com</li>
                <li>By phone number: 815-918-1967</li>
